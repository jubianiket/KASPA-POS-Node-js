...
import { createMenuItem, updateMenuItem, deleteMenuItem, getMenuItems } from '@/lib/actions';
...
export function MenuClient({ initialMenuItems }: { initialMenuItems: MenuItem[] }) {
